...
const props = defineProps<{
  resourceType: 'villa' | 'glamping' | 'homestay' | 'apartment' | 'gathering_venue' | 'transport'
  resourceSlug: string
}>()
...
const resourcePathSegment = computed(() => {
  if (props.resourceType === 'glamping') return 'glampings'
  if (props.resourceType === 'homestay') return 'homestays'
  if (props.resourceType === 'apartment') return 'apartments'
