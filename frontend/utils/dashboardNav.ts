...
export const DASHBOARD_NAV: Record<'admin' | 'mitra' | 'user', DashboardNavItem[]> = {
  admin: [
    ...
    { label: 'Moderasi Apartment', to: '/admin/apartments' },
    { label: 'Moderasi Gathering Venue', to: '/admin/gathering-venues' },
  ...
  mitra: [
    ...
    { label: 'Apartment', to: '/mitra/apartments' },
    { label: 'Gathering Venue', to: '/mitra/gathering-venues' },
